...
**There is an OS X branch of this repo that I (Deadpikle) have been building on for a work project. Much of the refactoring and fixes that took place there can be moved to the iOS editor (using NSTextStorage, etc.). If ANYONE has any time to hep refactor here, that would be great!**
